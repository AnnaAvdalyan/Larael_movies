                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Все актеры </h3>
                                <div class="nk-block-des text-soft">
                                    <p>You have total {{ count($actors) }} actors.</p>
                                </div>
                            ...
                            <div class="example-alert" style="margin: 15px 0;">
                                <div class="alert alert-success alert-icon">
                                    <em class="icon ni ni-check-circle"></em> <strong>Thanks for your
                                        deposit</strong>.{{ Session::get('deleted') }} </div>
                            </div>
                        @endif
                    </div><!-- .nk-block-head -->
                    <div class="nk-block">
                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list nk-tb-ulist is-compact">
                                        <div class="nk-tb-item nk-tb-head">
                                            <div class="nk-tb-col"><span class="sub-text">Имя </span></div>
                                            <div class="nk-tb-col tb-col-sm"><span class="sub-text">Дата рождения</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span class="sub-text">Место рождения</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span class="sub-text">Образование</span></div>
                                            <div class="nk-tb-col tb-col-lg"><span class="sub-text">Дебют</span></div>
...
{{--                                                            <span>{{substr( $actor->name, 0, 1) }} </span>--}}
                                                            <img src="{{ asset($actor->img) }}" alt="">
                                                        </div>
                                                        <div class="user-name">
                                                            <a href="/admin/actor/{{$actor->id}}"><span class="tb-lead">{{ $actor->name }}</span></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="nk-tb-col tb-col-lg">
                                                    <ul class="list-status">
                                                        <li> <span>{{ $actor->place_of_birth }}</span></li>
                                                    </ul>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span>{{ $actor->education }}</span>
                                                </div>
                                                <div class="nk-tb-col tb-col-lg">
                                                    <span>{{ $actor->debut }}</span>
                                                </div>
                                                <div class="nk-tb-col">
                                                    <span class="tb-status text-success"><em class="icon text-success ni ni-check-circle"></em>{{ $actor->status }}</span>
                                                </div>
