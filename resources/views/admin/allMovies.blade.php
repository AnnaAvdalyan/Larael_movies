                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Movies Lists</h3>
                                <div class="nk-block-des text-soft">
                                    <p>You have total   Movies.</p>
                                </div>
...
{{--                                                <div class="nk-tb-col nk-tb-col-check">--}}
{{--                                                    <div class="custom-control custom-control-sm custom-checkbox notext">--}}
{{--                                                        <input type="checkbox" class="custom-control-input" id="uid{{ $post->id }}">--}}
{{--                                                        <label class="custom-control-label" for="uid{{ $post->id }}"></label>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <div class="nk-tb-col">--}}
{{--                                                    <div class="user-card">--}}
...
{{--                                                        <li><em class="icon text-success ni ni-check-circle"></em> <span>{{ $post->year }}</span></li>--}}
{{--                                                    </ul>--}}
{{--                                                </div>--}}
{{--                                                <div class="nk-tb-col tb-col-lg">--}}
...
{{--                                                </div>--}}
{{--                                                <div class="nk-tb-col">--}}
{{--                                                    <span class="tb-status text-success">{{ $post->status }}</span>--}}
{{--                                                </div>--}}
